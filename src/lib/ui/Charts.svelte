<script lang="ts">
  ...
  // Placemarkers by Difficulty
    ...
    currentPlacemarkers.placemarkers.forEach((placemarker) => {
      ...
      if (placemarker.difficulty === "Easy" || placemarker.difficulty === "easy") {
        placemarkersByDifficulty.datasets[0].values[0] += 1;
      } else if (placemarker.difficulty === "Moderate" || placemarker.difficulty === "moderate") {
        placemarkersByDifficulty.datasets[0].values[1] += 1;
      } else if (placemarker.difficulty === "Hard" || placemarker.difficulty === "hard") {
        placemarkersByDifficulty.datasets[0].values[2] += 1;
      } else if (placemarker.difficulty === "Expert" || placemarker.difficulty === "expert") {
  ...
  <div class="columns">
    <div class="column box has-text-centered">
      <h1 class="title is-4">Placemarkers By Category (Pie Chart)</h1>
      <div id="pieChart" style="width: 100%; height: 400px;"></div>
    </div>
    <div class="column box has-text-centered">
      <h1 class="title is-4">Placemarkers By Difficulty (Bar Chart)</h1>
